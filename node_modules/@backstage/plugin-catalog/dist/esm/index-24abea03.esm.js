...
function EntityContextMenu(props) {
  ...
  const copyToClipboard = useCallback(() => {
    window.navigator.clipboard.writeText(window.location.toString()).then(() => alertApi.post({ message: "Copied!", severity: "info" }));
  }, [alertApi]);
...
const EntitySwitch = (props) => {
  ...
  if (hasAsyncCases) {
    return /* @__PURE__ */ React.createElement(AsyncEntitySwitch, { results });
  }
