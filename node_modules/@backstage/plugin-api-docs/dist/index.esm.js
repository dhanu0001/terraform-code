...
const LazyAsyncApiDefinition = React.lazy(
  () => import('./esm/AsyncApiDefinition-f7878ded.esm.js').then((m) => ({
...
const LazyOpenApiDefinition = React.lazy(
  () => import('./esm/OpenApiDefinition-cbea0eb2.esm.js').then((m) => ({
...
const ApiExplorerPage = apiDocsPlugin.provide(
  createRoutableExtension({
    ...
    component: () => import('./esm/index-a818a971.esm.js').then((m) => m.ApiExplorerIndexPage),
...
const EntityApiDefinitionCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-61d88006.esm.js').then((m) => m.ApiDefinitionCard)
    }
  })
);
const EntityConsumedApisCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-60bf7c27.esm.js').then((m) => m.ConsumedApisCard)
    }
  })
);
const EntityConsumingComponentsCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-0fc2831c.esm.js').then(
...
const EntityProvidedApisCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-60bf7c27.esm.js').then((m) => m.ProvidedApisCard)
    }
  })
);
...
const EntityHasApisCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-60bf7c27.esm.js').then((m) => m.HasApisCard)
    }
  })
);
