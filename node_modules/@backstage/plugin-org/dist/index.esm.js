...
import { makeStyles, createStyles, Grid, Box, Typography, Divider, ListItem, ListItemIcon, ListItemText, IconButton, List, Tooltip, ListItemSecondaryAction, Switch } from '@material-ui/core';
...
const EntityGroupProfileCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-6d0646ed.esm.js').then((m) => m.GroupProfileCard)
    }
  })
);
const EntityMembersListCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-6d0646ed.esm.js').then((m) => m.MembersListCard)
    }
  })
);
const EntityOwnershipCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-6d0646ed.esm.js').then((m) => m.OwnershipCard)
    }
  })
);
const EntityUserProfileCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-6d0646ed.esm.js').then((m) => m.UserProfileCard)
    }
  })
);
