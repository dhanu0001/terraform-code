...
const EntityLatestGithubActionRunCard = githubActionsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-734061a9.esm.js').then((m) => m.LatestWorkflowRunCard)
    }
  })
);
const EntityLatestGithubActionsForBranchCard = githubActionsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-734061a9.esm.js').then(
...
const EntityRecentGithubActionsRunsCard = githubActionsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-734061a9.esm.js').then((m) => m.RecentWorkflowRunsCard)
    }
  })
);
...
const generatedColumns = [
  ...
  },
  {
    ...
    render: (row) => {
      var _a, _b;
      return /* @__PURE__ */ React.createElement(Typography, { variant: "body2", noWrap: true }, /* @__PURE__ */ React.createElement("p", null, (_a = row.source) == null ? void 0 : _a.branchName), /* @__PURE__ */ React.createElement("p", null, (_b = row.source) == null ? void 0 : _b.commit.hash));
    }
  },
  {
    title: "Workflow",
