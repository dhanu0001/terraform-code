...
const StepFinishImportLocation = ({ prepareResult, onReset }) => {
  const continueButton = /* @__PURE__ */ React.createElement(Grid, { container: true, spacing: 0 }, /* @__PURE__ */ React.createElement(BackButton, { onClick: onReset }, "Register another"));
  if (prepareResult.type === "repository") {
    ...
    )), /* @__PURE__ */ React.createElement(Typography, { paragraph: true }, "Your entities will be imported as soon as the Pull Request is merged."), continueButton);
  }
