...
const RadarDescription = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(Dialog, { "data-testid": "radar-description", open, onClose }, /* @__PURE__ */ React.createElement(DialogTitle, { "data-testid": "radar-description-dialog-title" }, title), /* @__PURE__ */ React.createElement(DialogContent, { dividers: true }, /* @__PURE__ */ React.createElement(MarkdownContent, { content: description })), isValidUrl(url) && /* @__PURE__ */ React.createElement(DialogActions, null, /* @__PURE__ */ React.createElement(
    Button,
    {
      component: Link,
      to: url,
...
const RadarLegendLink = ({
  ...
  if (description) {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: classes.entry }, title)
    ), open && /* @__PURE__ */ React.createElement(
      RadarDescription,
      {
        open,
  ...
  return /* @__PURE__ */ React.createElement(WithLink, { url, className: classes.entryLink }, /* @__PURE__ */ React.createElement("span", { className: classes.entry }, title));
};
...
const RadarLegendRing = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { "data-testid": "radar-ring", key: ring.id, className: classes.ring }, /* @__PURE__ */ React.createElement("h3", { className: classes.ringHeading }, ring.name), entries.length === 0 ? /* @__PURE__ */ React.createElement("p", { className: classes.ringEmpty }, "(empty)") : /* @__PURE__ */ React.createElement("ol", { className: classes.ringList }, entries.map((entry) => /* @__PURE__ */ React.createElement(
    "li",
    {
      key: entry.id,
...
function RadarPage(props) {
  ...
  ), /* @__PURE__ */ React.createElement(SupportButton, null, /* @__PURE__ */ React.createElement("p", null, "This is used for visualizing the official guidelines of different areas of software development such as languages, frameworks, infrastructure and processes. You can find an explanation for the radar at", " ", /* @__PURE__ */ React.createElement(Link, { to: "https://opensource.zalando.com/tech-radar/" }, "Zalando Tech Radar"), "."))), /* @__PURE__ */ React.createElement(Grid, { container: true, spacing: 3, direction: "row" }, /* @__PURE__ */ React.createElement(Grid, { item: true, xs: 12, sm: 6, md: 4 }, /* @__PURE__ */ React.createElement(RadarComponent, { searchText, ...componentProps })))));
}
